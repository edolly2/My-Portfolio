 ...
 <!-- WRITE ME -->
                    ...
                    <div">
                        ...
                        <div class="form-cont">
                            ...
                            <form class="write-me-form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"> 
                                ...
                                <label for="comments">Comments <span class="red">*</span></label><br/>
                                <span class="error"><?php echo $commentErr; ?></span><br/>
                                <textarea name="comments" id="comments" class="is-focus" cols="38"
